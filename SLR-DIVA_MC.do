...
qui{
noisily: di "Use the agg file from : https://www.dropbox.com/s/4ijupm34vo51x7d/AggWithEU%20Separation.agg?dl=1 to generate the Sets, BaseData and Default.prm and change the directories in the code in copy. Press enter to continue" _request(asd)
...
copy BaseData.har "C:/SSA_TD_`Name'_(`Type')/CMF files `Name'_`x'_0_`=kk'/BaseData.har", replace
copy Sets.har "C:/SSA_TD_`Name'_(`Type')/CMF files `Name'_`x'_0_`=kk'/Sets.har", replace
copy Default.prm "C:/SSA_TD_`Name'_(`Type')/CMF files `Name'_`x'_0_`=kk'/Default.prm", replace
...
copy BaseData.har "C:/SSA_TD_`Name'_(`Type')/CMF files `Name'_`x'_`=kk'_`=$MCnoX'/BaseData.har", replace
copy Sets.har "C:/SSA_TD_`Name'_(`Type')/CMF files `Name'_`x'_`=kk'_`=$MCnoX'/Sets.har", replace
copy Default.prm "C:/SSA_TD_`Name'_(`Type')/CMF files `Name'_`x'_`=kk'_`=$MCnoX'/Default.prm", replace
...
copy BaseData.har "C:/SSA_LPD_(`Type')/CMF files Total_PiecewiseLinear_`x'_0_`=kk'/BaseData.har", replace
copy Sets.har "C:/SSA_LPD_(`Type')/CMF files Total_PiecewiseLinear_`x'_0_`=kk'/Sets.har", replace
copy Default.prm "C:/SSA_LPD_(`Type')/CMF files Total_PiecewiseLinear_`x'_0_`=kk'/Default.prm", replace
...
copy BaseData.har "C:/SSA_LPD_(`Type')/CMF files Total_PiecewiseLinear_`x'_`=kk'_`=$MCnoX'/BaseData.har", replace
copy Sets.har "C:/SSA_LPD_(`Type')/CMF files Total_PiecewiseLinear_`x'_`=kk'_`=$MCnoX'/Sets.har", replace
copy Default.prm "C:/SSA_LPD_(`Type')/CMF files Total_PiecewiseLinear_`x'_`=kk'_`=$MCnoX'/Default.prm", replace
